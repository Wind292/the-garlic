<script>
  ...
  const article = {
    ...
    body: `This weekend an anonymous whistleblower from Meta gave a tip to The Garlic. This tip consisted of a set of notes that described the events of a board meeting. The meeting was described as follows: “The senior innovation lead is presenting his new proposal today,  his plan is to riddle Meta sites with as many AI features as possible before inducing brain damage. He has developed this plan at the request of our highly intelligent investors who believe that AI could soon replace the customers themselves and generate infinite money.” Clearly the intentions of this whistleblower were to warn the public of the upcoming tragedy. The tragedy of Meta limiting the number of AI features it shoves in the face of the user in the name of “protecting brain health,” after all, everyone loves talking to a chatbot rather than real people, with the advent of AI I should never have to talk to another real person again, customer service is already moving this way, since customer service always indicates the next big thing, surely only talking to AI chatbots is the future of our society. This anonymous whistleblower and The Garlic couldn’t stand to see this horrific plan come to pass without changes, so we have decided to take action. The Garlic is starting the “Save AI” campaign on X later today, follow @thegarlic for info.`
  };
